          ...
          <div style={{ background: "#1e1e1e", borderRadius: "14px", margin: "8px 0 0", padding: "10px 12px 12px" }}>
            ...
            <div className="no-drag" style={{ display: "flex", justifyContent: "space-around" }}>
              <div onClick={() => window.open(import.meta.env.VITE_DASHBOARD_URL || "http://localhost:5173", "_blank")} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "3px", cursor: "pointer", padding: "5px 8px", borderRadius: "10px", minWidth: "52px" }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b0b0b0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
